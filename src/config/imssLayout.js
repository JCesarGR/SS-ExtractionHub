module.exports = {
  ...
  // Medidos directamente del PDF vectorial PLANTILLA_LABORATORIO.pdf
  person: {
    fullName: { x: 47,  y: 192, width: 300 },   // debajo de "Estimado(a),"
    nss:      { x: 68,  y: 219, width: 180 },   // a la derecha de "NSS:"
    curp:     { x: 74,  y: 239, width: 220 }    // a la derecha de "CURP"
  },

  // ─── Fecha del reporte (esquina superior derecha, página 1) ──────────
  // Opción A: una sola cadena "DD / MM / YYYY" centrada
  reportDate: {
    full:       { x: 461, y: 205, align: "center", width: 90 },
    totalWeeks: { x: 470, y: 237, align: "center", width: 50 }
  },
